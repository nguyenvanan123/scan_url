...
const GUIDE_STEPS = [
  ...
  },
  {
    ...
    points: [
      "Phần màu tím \"Real-World Attack Scenarios\" xuất hiện trong thẻ chi tiết của các lỗi: Missing X-Frame-Options, Missing CSP, SQL Injection, Sensitive File Exposed",
      "Chọn một kịch bản rồi bấm Launch This Scenario — trang mô phỏng mở trong tab mới",
      "Clickjacking: kéo thanh opacity để thấy iframe thật ẩn bên dưới lớp overlay lừa đảo",
      "XSS: bấm Sign In — headless browser thật kết nối đến URL mục tiêu, đọc cookie & localStorage trực tiếp từ trang đó rồi stream lên terminal",
      "SQLi: nhập URL có query param (vd ?id=1), bấm Run Live SQLi Probe — engine bắn payload thật (error-based + SLEEP(4) + EXTRACTVALUE) và hiển thị kết quả",
      "Sensitive File: chọn đường dẫn (/.env, /.git/HEAD, /wp-config.php…) rồi bấm Read Live File Content — backend fetch HTTP thật và hiển thị 10 dòng đầu",
    ],
    tip: null,
    tipKind: "info" as const,
  },
